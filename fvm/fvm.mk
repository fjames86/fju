...
fvm: ${BINDIR}/fvmc ${LIBDIR}/libfvm.a ${BINDIR}/fvm fvm/programs/test-rpc.fvm fvm/stdlib/stdlib.fvm fvm/test/test1.fvm
...
fvm/programs/test-rpc.fvm: ${BINDIR}/fvmc fvm/programs/test-rpc.asm
	${BINDIR}/fvmc -o fvm/programs/test-rpc.fvm -I fvm/stdlib/ fvm/programs/test-rpc.asm fvm/stdlib/native.asm
...
fvm/test/test1.fvm: ${BINDIR}/fvmc fvm/test/test1.asm ${BINDIR}/fvm
	${BINDIR}/fvmc -o fvm/test/test1.fvm fvm/test/test1.asm fvm/stdlib/native.asm
