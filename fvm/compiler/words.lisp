...
(defword call-myrpc ()
  ;; autogenerated code to encode args starting at bos
  ;; TODO
  ;; r0 contains arg length

  ;; set prog/vers/proc
  (br-pnz 2)
  (.blkw #x1234 #1234)
  (ld r1 -3)  ;; prog high word
  (ld r2 -3)  ;; prog low word
  (ldi r3 1)  ;; vers
  (ldi r4 0)  ;; proc
  
  ;; make call. r0 contains result status
  ;; r1 contains result length, bos contains result buffer
  (rpc)
  ...
  (ret)
  continue
  ;; autogenerated code to decode result buffer
  )
